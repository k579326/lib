...
elseif(IS_IOS)
	...
	elseif(CMAKE_OSX_ARCHITECTURES STREQUAL "arm64")
		set(T_ARM ON)
		set(T_IA OFF)
	elseif(CMAKE_OSX_ARCHITECTURES STREQUAL "armv7")
		set(T_ARM ON)
		set(T_IA OFF)
	else()
		message(FATAL_ERROR "target CPU arch ${CMAKE_OSX_ARCHITECTURES} not be supported!")
	endif()

	set(T_ARCH ${CMAKE_OSX_ARCHITECTURES})
	if (T_ARCH STREQUAL "arm64" AND CMAKE_IOS_TARGET_PLATFORM STREQUAL "simulator")
		set(T_ARCH "arm64-simulator")
	endif()
endif()
